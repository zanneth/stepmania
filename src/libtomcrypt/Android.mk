LOC_TOMCRYPT_PATH:= $(call my-dir)
LOCAL_PATH := $(LOC_TOMCRYPT_PATH)

include $(CLEAR_VARS)

LOCAL_MODULE:= libtomcrypt

LOCAL_SRC_FILES:= src/ciphers/aes/aes.c \
	src/hashes/md5.c \
	src/hashes/sha1.c \
...
LOCAL_C_INCLUDES := $(LOC_TOMCRYPT_PATH)/src/headers
LOCAL_CFLAGS := -DENDIAN_LITTLE -DENDIAN_32BITWORD
